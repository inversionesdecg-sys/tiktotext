"""
Tiktotex — Transcribe y resume tus colecciones de TikTok a Markdown.

Uso:
    python tiktotex.py --setup              # configurar credenciales (primera vez)
    python tiktotex.py                      # listar colecciones y elegir una
    python tiktotex.py --collection <id>    # procesar colección directamente
    python tiktotex.py --liked              # procesar todos los Me gusta
    python tiktotex.py --liked --limit 20   # Me gusta, últimos 20
    python tiktotex.py --url <url>          # un video suelto (TikTok o YouTube)
"""
import argparse
import sys
